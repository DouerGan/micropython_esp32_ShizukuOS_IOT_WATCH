...
class BMP280:
    def __init__(self, i2c_bus, addr=0x76, use_case=BMP280_CASE_HANDHELD_DYN):
        ...
        self.oversample(BMP280_OS_ULTRAHIGH )

        self.temp_os = BMP280_TEMP_OS_2
        self.press_os = BMP280_PRES_OS_16

        self.standby = BMP280_STANDBY_250
        self.iir = BMP280_IIR_FILTER_16
        self.off()
    ...
    def getAltitude(self):
        return (1-((self.pressure/101325)**(1/5.255)))*44330
    def off(self):
        self.power_mode = BMP280_POWER_SLEEP
    def on(self):
        self.power_mode = BMP280_POWER_NORMAL
